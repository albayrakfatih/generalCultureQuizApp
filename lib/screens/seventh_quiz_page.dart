...
class SeventhQuizPage extends StatefulWidget {
  const SeventhQuizPage({Key? key}) : super(key: key);

  @override
  State<SeventhQuizPage> createState() => _SeventhQuizPageState();
}

class _SeventhQuizPageState extends State<SeventhQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz7");

...
class ThirdQuizPage extends StatefulWidget {
  const ThirdQuizPage({Key? key}) : super(key: key);

  @override
  State<ThirdQuizPage> createState() => _ThirdQuizPage();
}

class _ThirdQuizPage extends State<ThirdQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz3");

...
class NinthQuizPage extends StatefulWidget {
  const NinthQuizPage({Key? key}) : super(key: key);

  @override
  State<NinthQuizPage> createState() => _NinthQuizPageState();
}

class _NinthQuizPageState extends State<NinthQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz9");

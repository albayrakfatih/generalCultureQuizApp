...
class FourthQuizPage extends StatefulWidget {
  const FourthQuizPage({Key? key}) : super(key: key);

  @override
  State<FourthQuizPage> createState() => _FourthQuizPageState();
}

class _FourthQuizPageState extends State<FourthQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz4");

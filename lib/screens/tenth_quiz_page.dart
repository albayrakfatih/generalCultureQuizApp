...
class TenthQuizPage extends StatefulWidget {
  const TenthQuizPage({Key? key}) : super(key: key);

  @override
  State<TenthQuizPage> createState() => _TenthQuizPageState();
}

class _TenthQuizPageState extends State<TenthQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz10");

...
class SixthQuizPage extends StatefulWidget {
  const SixthQuizPage({Key? key}) : super(key: key);

  @override
  State<SixthQuizPage> createState() => _SixthQuizPageState();
}

class _SixthQuizPageState extends State<SixthQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz6");

  // List<Question> _questions = [
  //   Question(
  //     id: '10',
  //     title: 'What is 10 + 20 = ?',
  //     options: {'40': false, '30': true, '50': false, '60': false},
  //   ),
  //   Question(
  //     id: '11',
  //     title: 'What is 100 + 120 = ?',
  //     options: {'80': false, '220': true, '50': false, '60': false},
  //   ),
  // ];

...
class EightQuizPage extends StatefulWidget {
  const EightQuizPage({Key? key}) : super(key: key);

  @override
  State<EightQuizPage> createState() => _EightQuizPageState();
}

class _EightQuizPageState extends State<EightQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz8");

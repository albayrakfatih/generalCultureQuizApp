...
class FifthQuizPage extends StatefulWidget {
  const FifthQuizPage({Key? key}) : super(key: key);

  @override
  State<FifthQuizPage> createState() => _FifthQuizPageState();
}

class _FifthQuizPageState extends State<FifthQuizPage> {
  //create an object for Dbconnect
  var db = DBconnect("quiz5");
